...
In the coming months, educators will be able to assign Gems (custom AI assistants) and notebooks from NotebookLM grounded in their class materials directly to students in Google Classroom. Gemini's new Guided Learning mode helps students understand concepts with step-by-step support rather than just providing answers, promoting deeper learning and critical thinking. Google has partnered with learning science experts, tested with youth advisory panels, and added extra data protection for all education users, ensuring that data from chats will not be used to improve AI models.`,
  ...
  // My school apps
  {
    ...
    fullDescription: `Consolidated tracking of G1/G2/G3 performance. Provides visual color-coding for eligibility and automated recommendations to speed up Results Management Day, reducing the process from 5 days to about 3 hours.`,
    icon: PieChart,
    ...
    features: [
      'Visual color-coding for eligibility',
      'Automated recommendations',
      'Reduces process from 5 days to 3 hours',
    ],
    platforms: ['Excel spreadsheet'],
    inAppPurchases: false,
  },
  {
    ...
    fullDescription: `Student wellbeing data analysis. Cohort-specific AI analysis of check-ins to surface risks and flag interventions, with integration into counseling workflows.`,
    icon: CheckSquare,
    category: 'My School Apps',
    gradient: 'from-green-500 to-emerald-600',
    developer: {
    ...
    features: [
      'Cohort-specific AI analysis',
      'Automated risk identification',
      'Intervention flagging',
      'Integration with counseling workflows',
    ],
    platforms: ['Pair Chat (AI-powered analysis)'],
    inAppPurchases: false,
  },
  {
    ...
    fullDescription: `Student movement tracking. A centralized system for recording absences and activities, sending weekly automated emails to all staff, and replacing individual email notifications. Requires discipline to maintain.`,
    icon: User,
    category: 'My School Apps',
    gradient: 'from-cyan-500 to-blue-600',
    developer: {
    ...
    features: [
      'Centralized system for absences/activities',
      'Weekly automated emails to all staff',
      'Replaces individual email notifications',
